...
router.get('/items-categories', checkUser, basicController.items_categories_get);
router.get('/super-items-categories', checkUser, basicController.super_items_categories_get);
...
router.get('/markets', checkUser, basicController.markets_get);

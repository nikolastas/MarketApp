...
items.append (Item("δημητρικά cheerios", "Δημητριακά",1))
...
items.append (Item("πατατάκια", "Aλλα Σνακς",1))
items.append (Item("Βεργίνα βαις", "Μπύρες",1))
items.append (Item("Οδοντοκρεμα", "Στοματική Υγιεινή",1))
items.append (Item("Κλινεξ", "Καθαριστικά Σπιτιού",1))
items.append (Item("Δωδώνη Γιαούρτι 2%", "Γιαούρτια & Επιδόρπια",1))

categories = categories = [["Δημητριακά", "Μπάρες δημητριακών","Παιδικά Δημητριακά","Φρυγανίες", "Ζαχαρί", "Ρύζια","Αλευρια & Ειδη Ζαχαροπλαστικής","Ψωμί","Παξιμάδια","Μπαχαρικά", "Ζυμαρικά" ,"Όσπρια", "Παντοπολείο", "Αλλαντικά", "Κρέας κά", "Προιόντα Ζύμης", "Κατεψυγμένα Λαχανικά", "Φρέσκα Φρούτα & Λαχανικά", "Ψάρια & Θαλάσσινά", "Μαρμελάδες, Μέλια & Αλλα αλείμματα"], 
["Γάλα", "Γιαούρτια & Επιδόρπια", "Κρέμες γάλακτος & Βούτυρα", "Παγωτά", "Τυριά", "Αλλα είδη Γάλακτος"], 
["Μπύρες", "Κρασιά","Ποτά" , "Νερά", "Φρεσκοι χυμοί" ,"Χυμοί εκτος ψυγείου & Αναψυκτικά","Μπισκότα", "Ξηροί καρποί","Σοκολάτες", "Aλλα Σνακς", "Καφές & Ροφήματα"],
